...
<table height="100%" width="100%" border="0">
    ...
    <tr>
        <td align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" width="400" align="center" border="1" style="border:0px solid #ddd;" id="table">
                <tbody>
                <tr>
    ...
    <div class="footer">
        <p class="v-box-box ">
            <span class="v-box">领导流行，展现品位，诚信至上，值得信赖，服务品质，顾客至上。</span>
        </p>
    </div>-->
</div>
