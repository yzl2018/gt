...
$currency_type = ['CNY'=>'￥','USD'=>'$'];
$curr = "";
if(array_key_exists(strtoupper($Currency),$currency_type)){
	$curr = $currency_type[strtoupper($Currency)];
}
?>
        ...
        <div class="content-main">
            ...
            <table style="font-size: 13px;">
                ...
                foreach ($Vouchers as $code => $key) {
                    ...
                    <tr>
                        <th>兑换密码</th>
                        <td class="font-bold"><?php echo $key; ?></td>
                    </tr>
                <?php
                }
                ?>
