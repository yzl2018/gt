<style type="text/css">
    ...
    .radius-5{
        ...
        behavior:url(/backend_storage/assets/images/ptc/pie.htc);/*兼容IE8 */
    }
    .bd-box{
    ...
    /* 头部 */
    .header{
        background: url(/backend_storage/assets/images/bg-head.png) no-repeat;
        height:100px;
        width:100%;
    }
    .header img{
    ...
    .bg-home{
        background-image:url(/backend_storage/assets/images/bg-home.png);
    }
    .bg-email{
        background-image:url(/backend_storage/assets/images/bg-email.png);
    }
    .footer>p{
        height: 100px;
        text-align:center;
...
<div class="main radius-5">
    <!-- s 头部 -->
    <div class="header">
        <!-- <img src="/backend_storage/assets/images/logo.png" />-->
    </div>
    <!-- e 头部 -->
    ...
    <div class="content">
        ...
        <div class="content-title text-danger">
            <h1><img src="/backend_storage/assets/images/failed.gif">支付失败！</h1>
        </div>
        <!-- 内容主体 -->
        <div class="content-main">
            ...
            <table>
                <tbody>
                <tr>
                    <td class="text-light-orange font-bold">错误码：{{$code}}</td>
    ...
    <div class="footer">
        <div class="success-action">
            <a href="/pages/user.html" class="failed-button radius-5" type="button">返回商城</a>
        </div>
